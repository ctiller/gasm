...
/-- CLI Emitter Target: Serializes and writes spike5_gzip_linux to disk from the verified program contract. -/
def main : IO UInt32 := do
  let exeBytes ← IO.ofExcept (emitVerifiedProgram spike5LinuxVerifiedProgram)
  let outputPath := "spike5_gzip_linux"
