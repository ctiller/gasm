...
namespace Spikes.Spike2Fibonacci.Linux.Row5BoundaryData
...
theorem spike2Row5SequentialCmp (dst : Reg64) (value : UInt8) :
...
theorem spike2Row5SequentialDivR10 : SequentialInstruction (div_r64 .r10) where
  encoding := .div .r10
  safeFallthrough := by
    intro state safe
...
end Spikes.Spike2Fibonacci.Linux.Row5BoundaryData
