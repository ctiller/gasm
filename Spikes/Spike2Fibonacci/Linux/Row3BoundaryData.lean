...
namespace Spikes.Spike2Fibonacci.Linux.Row3BoundaryData
...
theorem spike2Row3SequentialCmp (dst : Reg64) (value : UInt8) :
...
theorem spike2Row3SequentialDivR10 : SequentialInstruction (div_r64 .r10) where
  encoding := .div .r10
  safeFallthrough := by
    intro state safe
...
end Spikes.Spike2Fibonacci.Linux.Row3BoundaryData
