...
namespace Spikes.Spike2Fibonacci.Linux.Row2BoundaryData
...
theorem spike2Row2SequentialCmp (dst : Reg64) (value : UInt8) :
...
theorem spike2Row2SequentialDivR10 : SequentialInstruction (div_r64 .r10) where
  encoding := .div .r10
  safeFallthrough := by
    intro state safe
...
end Spikes.Spike2Fibonacci.Linux.Row2BoundaryData
