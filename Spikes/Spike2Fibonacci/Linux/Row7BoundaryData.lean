...
namespace Spikes.Spike2Fibonacci.Linux.Row7BoundaryData
...
theorem spike2Row7SequentialCmp (dst : Reg64) (value : UInt8) :
...
theorem spike2Row7SequentialDivR10 : SequentialInstruction (div_r64 .r10) where
  encoding := .div .r10
  safeFallthrough := by
    intro state safe
...
end Spikes.Spike2Fibonacci.Linux.Row7BoundaryData
