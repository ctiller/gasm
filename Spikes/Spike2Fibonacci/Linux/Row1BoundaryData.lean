...
namespace Spikes.Spike2Fibonacci.Linux.Row1BoundaryData
...
theorem spike2Row1SequentialCmp (dst : Reg64) (value : UInt8) :
...
theorem spike2Row1SequentialDivR10 : SequentialInstruction (div_r64 .r10) where
  encoding := .div .r10
  safeFallthrough := by
    intro state safe
...
end Spikes.Spike2Fibonacci.Linux.Row1BoundaryData
