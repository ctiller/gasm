...
namespace Spikes.Spike2Fibonacci.Linux.Row4BoundaryData
...
theorem spike2Row4SequentialCmp (dst : Reg64) (value : UInt8) :
...
theorem spike2Row4SequentialDivR10 : SequentialInstruction (div_r64 .r10) where
  encoding := .div .r10
  safeFallthrough := by
    intro state safe
...
end Spikes.Spike2Fibonacci.Linux.Row4BoundaryData
