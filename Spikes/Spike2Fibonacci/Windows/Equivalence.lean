...
/- REF: docs/EQUIVALENCE_PROOFS.md#1-mathematical-formulation-of-equivalence -/
/-- Constructive proof of mathematical equivalence: the x86-64 assembly routine computes exact Fibonacci numbers up to fib(90). -/
theorem fib_iter_asm_soundness :
    (List.range 91).all (fun n => runFibIterAsm n == (fibIter n).toUInt64) = true := by
  native_decide
