...
def build_gate_table(gzip_count: int) -> List[Dict]:
    ...
    return [
        ...
        {"key": "check_full_refs_launcher",
         "desc": "python scripts/test_full_refs_launcher.py",
         "group": "linters",
         "long": "mutation controls for opt-in refusal, argument rejection, clean-checkout command "
        ...
        {"key": "check_full_refs_authority",
         ...
         "group": "proofs",
         "long": "executable lifecycle controls for the protected full-repository declaration-"
                 "coverage authority, worker capabilities, replay rejection, and trace binding",
         "cmd": [py, "scripts/run_full_refs_coverage.py", "--self-test-authority"], "slow": False,
        ...
        {"key": "check_instructions_umbrella", "desc": "python scripts/check_instructions_umbrella.py",
         ...
         "long": "B3: exact Gasm/Targets/X86_64/Instructions.lean import closure. Every local "
                 ...
                 "Semantic family classification and typed proof-population checks are performed "
                 "by Lean's FamilyPipelineAudit, not by this filesystem linter.",
