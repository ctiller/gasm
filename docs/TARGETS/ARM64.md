...
During the initial historical reconnaissance (a revision-local milestone unrelated to canonical
memory-model stage M1), exact byte streams were generated by hand and booted under
`qemu-system-aarch64` to establish empirical ground truth:
