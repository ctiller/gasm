...
| Controlled x86 ISA expansion | [current qualification](X86_ISA_EXPANSION_PREREQUISITES.md#current-qualification-controlled-scalar-scale-is-ready) | MP+Reviewer-accepted design guidance; Trust acceptance pending | Pilot only deterministic current-state scalar forms; close scale gates before unconstrained expansion and keep excluded classes behind their owning seams |
