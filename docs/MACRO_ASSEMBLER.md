...
## Verified Microsoft x64 compiler-bulk spike

`Spikes.CompilerBulk.WindowsX64` demonstrates the corresponding bounded structured-Lean path on a
Windows x86-64 process artifact. The named four-argument `bulkExit` declaration contains structural
