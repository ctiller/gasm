...
-- XOR is register-only (`memAccesses _ := []`): see MemoryFrame/Add.lean's header comment for the
-- batch-lemma-instantiation rationale (identical here).

/- REF: docs/MEMORY_HOOK.md#33-the-declarative-access-descriptor-the-one-source-four-consumers-read -/
theorem XorR32R32.writesWithin (i : XorR32R32) : WritesWithin i :=
...
/- REF: docs/MEMORY_HOOK.md#33-the-declarative-access-descriptor-the-one-source-four-consumers-read -/
theorem XorR32R32.readsWithin (i : XorR32R32) : ReadsWithin i :=
