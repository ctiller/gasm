...
* **[docs/COMPILER_PLAN.md](docs/COMPILER_PLAN.md)**: Living plan for Lean compilation, handwritten replacement, target breadth, and VerifiedProgram completion gates.
